                    ...
                    <div class="d-block border rounded">
                        <div class="dashboard_author px-2 py-5">
                            <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                                ...
                                @else
                                    <img src="{{ asset('uploads/user') }}/{{ Auth::guard('customerlogin')->user()->photo }}"
                                        alt="profile">
                                @endif
                            </div>
                    ...
                    @foreach ($myorders as $order)
                        ...
                        <div class="ord_list_wrap border mb-4">
                            <div class="ord_list_head gray d-flex align-items-center justify-content-between px-3 py-3">
                                ...
                                <div>
                                    <a href="{{ route('download.invoice', $order->id) }}" class="btn btn-light">Download</a>
                                            ...
                                            <div class="cart_single d-flex align-items-start mfliud-bot">
                                                ...
                                                <div class="cart_single_caption pl-3">
                                                    ...
                                                    <h4 class="product_title fs-sm ft-medium mb-1 lh-1">
                                                        {{ $product->rel_to_product->product_name }}</h4>
                                                    <p class="mb-2"><span
                                                            class="text-dark medium">{{ $product->rel_to_size->size_name }}</span>,
                                                        <span
                                                            class="text-dark medium">{{ $product->rel_to_color->color_name }}</span>
                                                    </p>
                                ...
                                <div
                                    ...
                                    <div class="olf_flex_inner">
                                        <p class="m-0 p-0"><span
                                                class="text-muted medium text-left">{{ $order->created_at->format('d/m/Y g:i:s A') }}</span>
                                        </p>
                                    </div>
                                    <div class="olf_inner_right">
                                        <h5 class="mb-0 fs-sm ft-bold">&#2547;{{ $order->total }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
