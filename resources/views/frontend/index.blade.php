                        ...
                        <div class="text-left">
                            <div class="text-left">
                                ...
                                <div class="elis_rty">
                                    ...
                                    <span class="ft-bold theme-cl fs-lg mr-2">&#2547;{{$product->after_discount==null?'no discount':$product->after_discount}}</span></div>
                                </div>
                        </div>
                    </div>
                </div>
...
<section class="space min">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="ftr-title"><h4 class="ft-medium">Top rating Products</h4></div>
                <div class="ftr-content">
                    <!-- Single Item -->
                    @foreach ($best_selling_star->take(3) as $best_star)


                    <div class="product_grid row">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="{{route('details',$best_star->rel_to_product->slug)}}"><img class="card-img-top" src="{{asset('uploads/product/preview')}}/{{$best_star->rel_to_product->preview}}" alt="..."></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{$best_star->rel_to_product->rel_to_category->category_name}}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="{{route('details',$best_star->rel_to_product->slug)}}">{{$best_star->rel_to_product->product_name}}</a></h5>
                                <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">

                                    @php
                                    $total_star=App\Models\OrderProduct::where('product_id',$best_star->product_id)->wherenotNull('review')->sum('star');

                                    $total_review=App\Models\OrderProduct::where('product_id',$best_star->product_id)->wherenotNull('review')->count();
                                ...
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">{{round($best_star->rel_to_product->after_discount)}}&#2547;</span></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
