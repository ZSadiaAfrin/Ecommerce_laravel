                        ...
                        <div class="language-selector-wrapper dropdown js-dropdown float-right mr-3">
                            ...
                            <ul class="dropdown-menu popup-content link">
                                <li class="current"><a href="javascript:void(0);"
                                        class="dropdown-item medium text-muted"><img
                                            src="{{ asset('frontend/img/1.jpg') }}" alt="en" width="16"
                                        ...
                                        <div class="input-group">
                                            ...
                                            {{-- <div class="input-group-append">
                                                <div class="input-group-text"><button
                                                        ...
                                                        type="button" id="search_btn"><i
                                                            class="fas fa-search"></i></button></div>
                                            </div> --}}

                                            <div class="input-group-append">
                                                <div class="input-group-text"><a href="{{route('search')}}"
                                                        class="btn bg-white text-danger custom-height rounded px-3"
                                                        type="button" id="search_btn"><i
                            ...
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    ...
                                    <div class="cart_single_caption pl-2">
                                        ...
                                        <p class="mb-2"><span
                                                class="text-dark ft-medium small">{{ $cart->rel_to_size->size_name }}</span>,
                                            <span class="text-dark small">{{ $cart->rel_to_color->color_name }}</span>
                                        </p>
