        ...
        <ul class="nav">
            ...
            <div class="collapse" id="category">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  ...
                  <a href="{{route('subcategory')}}" class="nav-link">Subcatagory List</a>
                </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="product">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('add.product')}}" class="nav-link">Add new product category</a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="coupon">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('coupon')}}" class="nav-link">Add new coupon</a>
                </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#order" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
            ...
            <div class="collapse" id="order">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('orders')}}" class="nav-link">Add new order</a>
                </li>
